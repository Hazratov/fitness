...
const StatsCard = ({
    ...
    <div
        className={`relative overflow-hidden rounded-2xl p-6 transition-all duration-300 hover:scale-[1.02] ${gradientClass}`}>
                                ...
                                {data.bottom_section
                                    ...
                                    .map((item, index) => (
                                        <tr key={index}
                                            ...
                                            <td className="py-4" style={{paddingLeft: "20px"}}>{item.country}</td>
